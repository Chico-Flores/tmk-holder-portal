                  ...
                  <div className="flex-1 flex justify-end">
                    {user?.twitter_handle ? (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center gap-2 px-3 py-2 bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg transition-all group"
                        title={`View @${user.twitter_handle} on X`}
                        onClick={(e) => e.stopPropagation()}
                      >
                        {/* X Logo */}
                        <svg 
